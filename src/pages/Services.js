        ...
        <div>
            ...
            <div style={styles.container}>
                ...
                <div style={styles.serviceSection}>
                    ...
                    <p style={styles.description}>Jibreel’s general house cleaning service goes beyond surface cleaning to deliver a spotless, hygienic, and refreshing environment for your home. Our trained cleaning professionals use state-of-the-art equipment and eco-friendly cleaning products to tackle every nook and cranny, ensuring no corner is left untouched. From dusting and vacuuming to mopping and sanitizing, we tailor our cleaning solutions to meet your specific needs. Whether you need routine maintenance or a one-time deep clean, Jibreel ensures a pristine living space for you and your loved ones. Trust us to handle the details so you can focus on what matters most—creating memories in a clean and welcoming home.</p>
                </div>
                ...
                <div style={styles.serviceSection}>
                    ...
                    <p style={styles.description}>Relocating can be a stressful experience, but Jibreel’s Movers Services are here to make your move seamless, efficient, and worry-free. From initial planning to final delivery, our team manages every detail with precision and care. We provide professional packing services using high-quality materials to protect your belongings during transit. Our experienced movers handle furniture, appliances, and fragile items with utmost care, ensuring they reach their destination in perfect condition. We also offer unpacking and setup services to help you settle into your new space effortlessly. Whether you're moving locally or long-distance, Jibreel guarantees a smooth and hassle-free relocation process.</p>
                </div>
                ...
                <div style={styles.serviceSection}>
                    ...
                    <p style={styles.description}>Your sofa is a centerpiece of comfort and style, and Jibreel’s sofa repair services are designed to give it a second life. Our skilled craftsmen specialize in repairing and restoring all types of sofas, from modern designs to antique pieces. We address structural issues such as broken frames, sagging cushions, and loose joints, ensuring your furniture regains its durability and comfort. Our upholstery experts also replace worn-out fabric or leather, offering a wide range of premium materials to match your aesthetic preferences. With Jibreel, your sofa will not only be functional but also exude elegance and charm.
                ...
                <div style={styles.serviceSection}>
                    ...
                    <p style={styles.description}>Over time, outdoor surfaces can accumulate dirt, mold, and stubborn stains that diminish your property’s curb appeal. Jibreel’s pressure washing services are the perfect solution for revitalizing these areas. Using high-pressure water jets, we effectively clean driveways, patios, decks, walls, and fences, removing grime, algae, and other unsightly residues. Our eco-friendly approach ensures no damage to your surfaces while restoring their original shine. Whether it’s a routine cleaning or a pre-sale property enhancement, Jibreel’s pressure washing services deliver results that leave your outdoor spaces looking immaculate.</p>
                </div>
